                            ...
                            <div className="sect">
                                <form style={{ fontSize: "15px;" }}>
                                    <div style={{ marginBottom: "10px" }}>
                                        ...
                                        <input type="text" placeholder="Name" className="form-control rname" style={{ fontSize: '15px'}} required />
                                        <input type="text" placeholder="Email" className="form-control remail" style={{ fontSize: '15px'}} required />
                                        <input type="tel" placeholder="Mobile number" maxLength={10} className="form-control mob" style={{ fontSize: '15px'}} required />

                                    </div>
                                </form>
                                <div className='file_upload' style={{ display: "block" }}>
                                    <b style={{ fontSize: '16px'}}>Format : </b> Name, Email and Mobile number&nbsp;&nbsp;&nbsp;<a className="linktodow" href={sample}>(Download Sample XLSX file)</a><br /><br />
